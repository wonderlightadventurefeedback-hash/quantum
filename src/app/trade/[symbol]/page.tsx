              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 text-muted-foreground text-sm font-medium">
                    ...
                    <span className="text-muted-foreground opacity-50">Depth</span>
                  </div>
                </div>
              </div>
                ...
                <div className="flex p-1 bg-muted/50 rounded-2xl">
                  <button 
                    ...
                    className={cn(
                      ...
                      activeTab === "BUY" ? "bg-primary text-primary-foreground shadow-lg" : "text-muted-foreground"
                    )}
                  >
                    BUY
                  </button>
                  <button 
                    ...
                    className={cn(
                      "flex-1 py-2 text-sm font-bold rounded-xl transition-all",
                      activeTab === "SELL" ? "bg-destructive text-destructive-foreground shadow-lg" : "text-muted-foreground"
                    )}
                  >
                    SELL
                  </button>
                ...
                <div className="pt-4 space-y-3">
                  ...
                  <Button 
                    className={cn(
                      ...
                      activeTab === "BUY" ? "bg-primary text-primary-foreground" : "bg-destructive text-destructive-foreground"
                    )}
                    onClick={handleOrder}
                  >
