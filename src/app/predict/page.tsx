  ...
  return (
    <DashboardShell>
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div>
          <h1 className="text-3xl font-headline font-bold">Prediction Arena</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button 
                    ...
                    className={`h-20 flex-col gap-2 rounded-2xl ${prediction === 'UP' ? 'bg-green-600 hover:bg-green-700' : ''}`}
                  ...
                  <Button 
                    ...
                    className={`h-20 flex-col gap-2 rounded-2xl ${prediction === 'DOWN' ? 'bg-red-600 hover:bg-red-700' : ''}`}
          ...
          <div className="space-y-6">
            ...
            <Card className="glass-card">
              ...
              <CardContent>
                <div className="text-4xl font-headline font-bold mb-2">78.4%</div>
        ...
        {/* AI Result View */}
        {result && (
          <Card className="glass-card border-primary/40 bg-primary/5 animate-in zoom-in-95 duration-500">
            <CardHeader className="flex flex-row items-center justify-between border-b border-primary/10 mb-6">
              <div>
                <CardTitle className="text-2xl font-headline">Analysis Result: {result.predictionOutcome}</CardTitle>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="space-y-4">
                <div className="text-sm font-medium text-muted-foreground">User Prediction</div>
                <div className="flex items-center gap-2 text-xl font-bold">
                  {prediction === 'UP' ? <TrendingUp className="text-green-500" /> : <TrendingDown className="text-red-500" />}
                  {prediction} ({confidence[0]}%)
                </div>
                <div className="text-sm font-medium text-muted-foreground mt-4">AI Prediction</div>
                <div className="flex items-center gap-2 text-xl font-bold">
                  {result.aiPrediction === 'UP' ? <TrendingUp className="text-green-500" /> : <TrendingDown className="text-red-500" />}
                  {result.aiPrediction}
                </div>
              </div>
              <div className="md:col-span-2 space-y-4">
                <div className="text-sm font-medium text-muted-foreground">AI Rationale & Feedback</div>
