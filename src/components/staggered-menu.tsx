  ...
  return (
    <div className={`sm-scope ${isFixed ? 'fixed inset-0 pointer-events-none' : 'relative w-full h-full'} z-[100]`}>
      <div className={`${className || ''} staggered-menu-wrapper pointer-events-none relative w-full h-full`}
        ...
        <header className="staggered-menu-header fixed top-0 left-0 w-full flex items-center justify-between p-8 bg-transparent pointer-events-none z-[110]" aria-label="Main navigation header">
